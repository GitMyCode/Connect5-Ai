...
*/
public abstract class AbstractPriorityQueue<E> extends AbstractOrderedCollection<E> {
  ...
  */
   ...
   *   also a priority queue, both priority queues have the same
   *   size, and all corresponding pairs of elements in the two
   *   priority queues are equal.
   *  (Two elements e1 and e2 are equal if
   *  <pre><b>  (e1==null ? e2==null : e1.equals(e2))</pre></b>
   *  In other words, two priority queues are defined to be equal if they
   *    contain the same elements, and they will be removed in the same
   *    order.
   * <p>
   * This implementation first checks if the specified object is this
   *   priority queue.
   * If so, it returns <code>true</code>; if not, it checks if the
   *   specified object is a priority queue.
   * If not, it returns <code>false</code>; if so, it iterates over
   *    both priority queues, comparing corresponding pairs of elements.
  ...
  */
  public boolean equals(Object o) {
	  if (o == this)
	     return true;
	  if (!(o instanceof AbstractPriorityQueue))
	    return false;

	  Iterator<E> e1 = iterator();
	  Iterator    e2 = ((AbstractPriorityQueue) o).iterator();
	  if ( size() != ((AbstractPriorityQueue) o).size() )
	    return false;
